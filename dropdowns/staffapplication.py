...
application_ticket_category_id = data["Channel_Categories"]["TICKET_CATEGORY_ID"]
...
class StaffApplicationDropdown(discord.ui.Select):
    def __init__(self):
        ...
        options = [
            ...
            discord.SelectOption(label='Lead Commission Manager'),
            discord.SelectOption(label='Commission Manager'),
            discord.SelectOption(label='-------Applications-------'),
            discord.SelectOption(label='Lead Application Reviewer'),
