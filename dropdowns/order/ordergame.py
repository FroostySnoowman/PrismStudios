...
class OrderGameDropdown(discord.ui.Select):
    def __init__(self):
...
class OrderGameDropdownView(discord.ui.View):
    def __init__(self):
        super().__init__()

        self.add_item(OrderGameDropdown())

class OrderGameCog(commands.Cog):
    def __init__(self, bot):
        self.bot = bot

async def setup(bot):
    await bot.add_cog(OrderGameCog(bot), guilds=[discord.Object(id=guild_id)])