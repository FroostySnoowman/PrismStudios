...
class OrderVideoDropdown(discord.ui.Select):
    def __init__(self):
...
class OrderVideoDropdownView(discord.ui.View):
    def __init__(self):
        super().__init__()

        self.add_item(OrderVideoDropdown())

class OrderVideoCog(commands.Cog):
    def __init__(self, bot):
        self.bot = bot

async def setup(bot):
    await bot.add_cog(OrderVideoCog(bot), guilds=[discord.Object(id=guild_id)])