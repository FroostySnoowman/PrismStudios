...
support_ticket_category_id = data["Channel_Categories"]["TICKET_CATEGORY_ID"]
ticket_support_role_id = data["Roles"]["TICKET_SUPPORT_ROLE_ID"]
...
class Support(discord.ui.Modal, title='Support Ticket'):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        support_specialist = interaction.guild.get_role(ticket_support_role_id)
